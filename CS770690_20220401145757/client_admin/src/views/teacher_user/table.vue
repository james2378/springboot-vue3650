<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/teacher_user/table','add') || $check_action('/teacher_user/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/teacher_user/table','del') || $check_action('/teacher_user/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="teacher_job_number" label="老师工号"
			...
			<el-table-column prop="teacher_gender" label="老师性别"
				v-if="user_group == '管理员' || $check_field('get','teacher_gender')" min-width="200">
			</el-table-column>
			<el-table-column prop="teacher_age" label="老师年龄"
			...
			<el-table-column prop="teacher_certificate" label="老师证件"
				v-if="user_group == '管理员' || $check_field('get','teacher_certificate')" min-width="200">
				<template slot-scope="scope">
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['teacher_certificate'])"
						:preview-src-list="[$fullUrl(scope.row['teacher_certificate'])]">
