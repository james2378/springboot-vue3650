<template>
	<div class="diy_home diy_list diy_project_declaration" id="diy_project_declaration_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/project_declaration/details?project_declaration_id=' + o['project_declaration_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/project_declaration/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/project_declaration/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','project_identification')">项目认定书
					</th>
					<th class="diy_title" v-if="$check_field('get','instructor')">指导老师
					</th>
					<th class="diy_title" v-if="$check_field('get','date_of_filling')">填表日期
					</th>
					<th class="diy_title" v-if="$check_field('get','teacher_rating')">老师评分
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field" v-if="$check_field('get','project_identification')">
						<img class="diy_img" :src="o['project_identification']" />
					</td>
					...
					<td class="diy_field diy_text" v-if="$check_field('get','teacher_rating')">
						<span>
							{{ o["teacher_rating"] }}
						</span>
					</td>
