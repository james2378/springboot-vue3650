<template>
	<div class="diy_home diy_list diy_final_acceptance" id="diy_final_acceptance_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/final_acceptance/details?final_acceptance_id=' + o['final_acceptance_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/final_acceptance/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/final_acceptance/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','contract_amount')">合同金额
					</th>
					<th class="diy_title" v-if="$check_field('get','amount_in_place')">到位金额
					</th>
					<th class="diy_title" v-if="$check_field('get','actual_expenditure')">实际支出
					</th>
					<th class="diy_title" v-if="$check_field('get','date_of_filling')">填表日期
					</th>
					<th class="diy_title" v-if="$check_field('get','hospital_level_audit')">院级审核
					</th>
					<th class="diy_title" v-if="$check_field('get','reason_for_conclusion')">结题原因
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_number" v-if="$check_field('get','contract_amount')">
						<span>
							{{ o["contract_amount"] }}
						</span>
					</td>
					<td class="diy_field diy_number" v-if="$check_field('get','amount_in_place')">
						<span>
							{{ o["amount_in_place"] }}
						</span>
					</td>
					<td class="diy_field diy_number" v-if="$check_field('get','actual_expenditure')">
						<span>
							{{ o["actual_expenditure"] }}
						</span>
					</td>
					<td class="diy_field diy_date" v-if="$check_field('get','date_of_filling')">
						<span>
							{{ $toTime(o["date_of_filling"] ,"yyyy-MM-dd") }}
						</span>
					</td>
					...
					<td class="diy_field diy_text" v-if="$check_field('get','reason_for_conclusion')">
						<span>
							{{ o["reason_for_conclusion"] }}
						</span>
					</td>
				</tr>
			</table>
