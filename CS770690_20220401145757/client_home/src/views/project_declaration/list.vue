<template>
	<div class="diy_list page_project_declaration" id="project_declaration_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">项目申报列表</span>
					</div>
				</div>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_project_declaration :list="list" />
						<!-- /列表 -->
					</div>
				</div>
...
<script>
	import list_project_declaration from "@/components/diy/list_project_declaration.vue";
